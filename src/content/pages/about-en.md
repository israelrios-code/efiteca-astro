...
trajectory:
  ...
  description: |-
    Efiteca was born with a clear objective: transform the way people live the mortgage process.
...
purposeSection:
  title: Our purpose
  description: |-
    We believe it should not be so difficult to access a home.
  ...
  bullets:
    ...
    - Support from diagnosis to signing
partners:
  title: Financial institutions we work with
  description: "We work with financial institutions and real-estate ecosystem partners to offer real options tailored to each profile."
  items:
    - name: Santander
    - name: BBVA
    - name: Sabadell
...
testimonials:
  ...
  description: "People in real situations were able to make decisions more clearly, improve terms or secure their mortgage with expert support and coordination through signing."
  items:
    - name: Carlos Gomez
...
recognitions:
  ...
  items:
    ...
    - title: Trusted Company
      subtitle: "2024 - Verified client reviews"
    - title: Innovation in Finance
      subtitle: "Recognition for clarity in the support model"
companyInfo:
